            ...
            while (chars.MoveNext())
            {
                ...
                switch (c)
                {
                    ...
                    case '/':
                        ...
                        break;
                    case '-':
                        if (tokens.Count == 0 || tokens[^1].Type == TokenType.Operator || tokens[^1].Type == TokenType.ParenL)
                        {
                            var num = "-";
                    ...
                    default:
                        ...
                        {
                            var func = c.ToString();
                            while (chars.MoveNext() && char.IsLetter(chars.Current))
                            {
                                func += chars.Current;
                            }
            ...
            while (i < tokens.Count)
            {
                ...
                switch (token.Type)
                {
                    ...
                    case TokenType.ParenR:
                        while (operators.Peek().Type != TokenType.ParenL)
                        {
                            output.Add(operators.Pop());
                        }
                        operators.Pop();
