...
namespace FNAFStudio_Runtime_RCS.Util
{
    public static class RuntimeUtils
    {
        ...
        public static void SetGameIcon(string image)
        {
            ...
            Texture texture = Cache.GetTexture(image);
        ...
        /// Start the night.
        /// </summary>
        public static void StartNight() => Scene.SetScene(Data.Definitions.SceneType.Office);
        ...
        public static unsafe string SBytePointerToString(sbyte* sbytePointer)
        {
            ...
            {
                byteArray[i] = (byte)sbytePointer[i];
            }
        ...
        public static GameJson.Input? ConvertOldCamera()
        {
            ...
            {
                Image = (GameState.Project.Offices[OfficeCore.Office].OldUIButtons ?? new()).Camera.Image ?? "",
                Position = (GameState.Project.Offices[OfficeCore.Office].OldUIButtons ?? new()).Camera.Position
            };
        }
        ...
        public static GameJson.Input? ConvertOldMask()
        {
            ...
            return new GameJson.Input()
            {
                Image = ((GameState.Project.Offices[OfficeCore.Office].OldUIButtons ?? new())).Mask.Image ?? "",
                Position = (GameState.Project.Offices[OfficeCore.Office].OldUIButtons ?? new()).Mask.Position
            };
        }
